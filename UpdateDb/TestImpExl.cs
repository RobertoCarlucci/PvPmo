            ...
            string _azione, string _tabConf, string _colConf, string _tabTest, string _colTest, string _dbConf, string _dbTest)
        {
            ...
            switch (_azione)
            {
                case "TST":
                    ...
                    dataTest = await SqlAsync.SqlQryDataTable(StrConnTest, QrySqlTest, dataTest);
                    dataConf = await SqlAsync.SqlQryDataTable(StrConnConf, QrySqlConf, dataConf);
                ...
                case "NUM":
                    ...
                    await SqlAsync.SqlQryDataReader(StrConnTest, QrySqlTest, dataTest);
                    await SqlAsync.SqlQryDataReader(StrConnConf, QrySqlConf, dataConf);
