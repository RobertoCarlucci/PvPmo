...
public partial class SqlAsync
{
    ...
    public static async Task<bool> SqlBulkCopy(string strConn, string tableName, DataTable data, int timeoutSec = 30, List<MySqlBulkCopyColumnMapping>? mappings = null)
    {
        try
        {
