...
{
    public static DataTable LoadDt(DataTable _dataTable)
    {
        //string StrConnSql = Conn.MysqlConn("pvpmo_origine");
        //string Qry = "SELECT * FROM `pv-total`;";
        //_dataTable = SqlSync.SqlQryDataTable(StrConnSql, Qry, _dataTable);
        return _dataTable;
    }
    public static void ExportDataTable(DataTable dt, string destination)
    {
        ...
        //    foreach (var dt in dt.Tables)
        //    {
        //        var sheetPart = workbook.WorkbookPart.AddNewPart<WorksheetPart>();
        //        var sheetData = new DocumentFormat.OpenXml.Spreadsheet.SheetData();
        //        sheetPart.Worksheet =
        //            new DocumentFormat.OpenXml.Spreadsheet.Worksheet(sheetData);
        ...
        //            new DocumentFormat.OpenXml.Spreadsheet.Sheet() { Id = relationshipId, SheetId = sheetId, Name = table.TableName };
        //        sheets.Append(sheet);
        ...
        //            cell.CellValue =
        //                new DocumentFormat.OpenXml.Spreadsheet.CellValue(column.ColumnName);
        ...
        //                cell.DataType = DocumentFormat.OpenXml.Spreadsheet.CellValues.String;
        //                cell.CellValue =
        //                    new DocumentFormat.OpenXml.Spreadsheet.CellValue(dsrow[col].ToString()); //
